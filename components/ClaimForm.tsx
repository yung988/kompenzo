    ...
    <div className="container mx-auto px-4 py-8 max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <Label htmlFor="bankAccount">Číslo účtu pro vrácení peněz</Label>
            <Input 
              id="bankAccount" 
              name="bankAccount" 
        ...
        <div>
          <Label htmlFor="paymentMethod">Způsob vrácení peněz</Label>
          <Select 
            name="paymentMethod" 
          ...
          >
            <SelectTrigger>
              <SelectValue placeholder="Vyberte způsob vrácení peněz" />
            </SelectTrigger>
            <SelectContent>
              <SelectItem value="bank">Bankovním převodem</SelectItem>
              <SelectItem value="credit">Kredit na další jízdenky</SelectItem>
            </SelectContent>
          </Select>
        </div>
